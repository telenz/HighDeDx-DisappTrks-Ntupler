...
// $Id: DeDxDiscriminatorProducer.cc,v 1.1 2011/11/18 16:00:05 querten Exp $
//
//
...
double DeDxDiscriminatorProducer::GetPixelProbability(const SiPixelCluster*   cluster, TrajectoryStateOnSurface trajState,
						 const uint32_t &               detId)
{
   // Get All needed variables
   LocalVector             trackDirection = trajState.localDirection();
...
void DeDxDiscriminatorProducer::MakeCalibrationMap(unsigned int run){
