...
int refittedTracksDiagnostics()
{
  ...
  TH1D* hDeltaPtOverPtErrorTrackRefitter          = new TH1D("hDeltaPtOverPtErrorTrackRefitter","hDeltaPtOverPtErrorTrackRefitter",60,0,30);
  TH1D* hDeltaPtOverPtErrorGeneralTracks          = new TH1D("hDeltaPtOverPtErrorGeneralTracks","hDeltaPtOverPtErrorGeneralTracks",60,0,30);
  ...
  plotTH1(hChi2NDFTrackRefitterUnMatched,"TrackRefitter PtError/Pt","hptErrorTrackRefitterUnMatched");
